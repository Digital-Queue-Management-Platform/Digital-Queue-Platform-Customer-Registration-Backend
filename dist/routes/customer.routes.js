...
const generateTokenNumber = async (outletId) => {
...
router.post('/register', async (req, res) => {
    try {
        ...
        const currentPosition = await Customer_1.Customer.countDocuments({
            outletId,
            status: 'waiting'
        }) + 1;
        ...
        await Queue_1.Queue.findOneAndUpdate({ outletId, date: queueTodayStart }, {
            $inc: { totalWaiting: 1 },
